#!/usr/bin/env python3
"""
Round 12: Qwen2.5-7B-Instruct 模型切換測試
使用 R8a 最佳配置：v3 + sentence rewrite + HyDE + BM25 hybrid + reranker
唯一差異：LLM 從 llama3 切換為 qwen2.5:7b-instruct-q8_0
"""
import os
import sys
import json
...
def run_test():
    run_label = "R12_dbv3_k3_rw-sentence_hyde_hybrid-bm25_reranker_qwen25"
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    db_version = "v3"
    llm_model = "qwen2.5:7b-instruct-q8_0"

    print("=" * 60)
    print(f"  Round 12: Qwen2.5-7B-Instruct 模型切換測試")
