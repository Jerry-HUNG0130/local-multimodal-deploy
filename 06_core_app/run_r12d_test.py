#!/usr/bin/env python3
"""
Round 12d: Qwen2.5 + Few-Shot Prompt (v3)
R12 配置 + 3 個精準 few-shot 範例（正確引用、排除條款、規章未說明）
驗證 Qwen2.5 的 32K context 能否善用 few-shot 而不像 Llama3 (R9) 被擠壓
"""
import os
import sys
import json
